...
import { useNavigate, Link } from 'react-router-dom'; // ១. បន្ថែម Link ក្នុង Import
    ...
    <section className="bg-gray-950 py-16 font-khmer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          {/* ២. ប្តូរពី <a> ទៅ <Link> ដើម្បីដោះស្រាយ Error ពេល Build */}
          <Link to="/khmer-movies" className="text-yellow-500 hover:text-yellow-400 text-sm font-medium transition-colors">
            មើលទាំងអស់ &rarr;
          </Link>
        </div>
